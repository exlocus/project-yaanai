Вот пример файла `README.md`, который описывает ваше расширение для браузера:
...
Вот два гайда по установке вашего расширения для Windows и Android, учитывая указанные вами детали:

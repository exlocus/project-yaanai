...
Проект YaanAI больше не будет обновляться. Все наработки, включая новые функции и объявления, будут выходить в рамках нового проекта: [FlexAnswer](https://github.com/exlocus/flexanswer). Благодарим за поддержку и интерес!  

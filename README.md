...
К сожалению, **YaanAI не поддерживается на iOS**. Однако вы можете попробовать запустить его с помощью универсального пакета ([YaanAI-Universal.zip](https://github.com/exlocus/project-yaanai/releases)), если разберетесь, как это сделать.
